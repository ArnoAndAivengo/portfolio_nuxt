export const ARTICLE_PAGES = {
  ...
  issues: {
    ...
    seoTitle: 'Техблог CodeVega — Александр Обухов',
    seoDescription: 'Пятничный техблог о разработке обучающей платформы CodeVega: архитектура, инфраструктура, курсы и живой опыт fullstack-разработки.',
  },
  post: {
    pageKey: 'articles',
    current: 'posts',
