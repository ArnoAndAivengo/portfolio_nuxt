...
<template>
  ...
  >
    <div class="profile-links__row">
      <a
        class="profile-links__item profile-links__item--github"
        :href="github"
        target="_blank"
      ...
      <a
        class="profile-links__item profile-links__item--gitlab"
        :href="gitlab"
        target="_blank"
        rel="noopener noreferrer"
      >
    ...
    >
      ...
      >
        <svg
          ...
          aria-hidden="true"
        >
          <path d="M10 4l-6 8 6 8M14 4l6 8-6 8" />
        </svg>
        LeetCode
      </a>
    </div>
